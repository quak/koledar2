  ...
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('eventCal', function () {
    ...
    return {
        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch('https://admin.koledar.at/v1/locations?includeChildren=true');
              case 2:
          ...
          return _regeneratorRuntime().wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 4;
                return fetch('https://admin.koledar.at/v1/events?limit=' + limit + '&offset=0&from=' + datestr + catquery);
              case 4:
            ...
            while (1) switch (_context4.prev = _context4.next) {
              ...
              case 21:
                ...
                if (kscript.getAttribute('kk-style') == "list") {
                  ...
                  for (j = 0; j < evsl.length; j += chunkSize) {
      ...
      fetchAddEventList: function fetchAddEventList() {
        ...
        var evsl = new Array();
        var evat = new Array();
        fetch('https://admin.koledar.at/v1/events?limit=' + limit + '&offset=' + offset + '&from=' + datestr).then(function (res) {
          return res.json();
        }).then(function (data) {
